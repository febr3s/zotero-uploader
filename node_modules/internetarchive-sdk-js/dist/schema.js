...
export const CreateItemRequestHeaders = z.intersection(z.object({
    ...
    'x-archive-meta-mediatype': Mediatype,
}).superRefine(oneOf('x-archive-meta-collection', 'x-archive-meta01-collection')), z.record(z.string(), z.any()));
