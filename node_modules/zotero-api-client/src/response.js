...
class ApiResponse {
	 ...
	 */
	getServerID() {
		return this.response?.headers?.get('Zotero-Server-ID') ?? null;
	}
}
...
class AuthorizeResponse extends ApiResponse {
	 ...
	 */
	isRemembered() {
		return this.raw?.remember ?? false;
	}
}
